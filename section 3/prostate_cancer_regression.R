...
library(corrplot) ; library(psych) ; library(glmnet) ; library(MASS)
...
ridge <- cv.glmnet(X, y, nfolds = 10, trace.it = 1, alpha = 0,
                   lambda = 10^seq(10, -2, length.out = 100)) # Ridge with CV10
